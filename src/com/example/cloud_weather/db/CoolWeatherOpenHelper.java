...
public class CoolWeatherOpenHelper extends SQLiteOpenHelper{
	...
	private static final String CREATE_PROVINCES="create table province("
	...
	private static final String CREATE_COUNTIES="create table counties(county_id integer primary key autoincrement,"
			+ "county_name text,county_code text,city id integer)";
